...
- **C** - *( [C](https://en.wikipedia.org/wiki/C_(programming_language)), [C#](https://docs.microsoft.com/en-us/dotnet/csharp/) , [C++](https://en.wikipedia.org/wiki/C%2B) , [CSS](https://en.wikipedia.org/wiki/Cascading_Style_Sheets) [circleCI](https://circleci.com/))*
...
- **R** - *( [R](https://www.r-project.org/), [REST](https://en.wikipedia.org/wiki/Representational_state_transfer), [ReactNative](https://reactnative.dev/), [Ruby](https://www.ruby-lang.org/en/), [Rust](https://www.rust-lang.org/), [Rancher](https://rancher.com/), [Rollup](https://rollupjs.org/guide/en/) )*

- **S** - *( [Scala](https://www.scala-lang.org/), [Swift](https://developer.apple.com/swift/), [Stack-Overflow](https://stackoverflow.com/), [SQL](https://en.wikipedia.org/wiki/SQL), [Strapi](https://strapi.io/), [SOAP](https://en.wikipedia.org/wiki/SOAP), [Sass](https://sass-lang.com/), [SnowPack](https://snowpack.dev) )*
